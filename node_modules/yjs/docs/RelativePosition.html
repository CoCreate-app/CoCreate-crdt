...
<head>
    <meta charset="utf-8">
    <title>Class: RelativePosition | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>RelativePosition<span class="signature">(type, tname, item)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>A relative position is based on the Yjs model and is not affected by document changes.
E.g. If you place a relative position before a certain character, it will always point to this character.
If you place a relative position at the end of a type, it will always point to the end of the type.</p>
<p>A numeric position is often unsuited for user selections, because it does not change when content is inserted
before or after.</p>
<p><code>Insert(0, 'x')('a|bc') = 'xa|bc'</code> Where | is the relative position.</p>
<p>One of the properties must be defined.</p></div>
...
<dt>
        ...
        <h4 class="name" id="RelativePosition">
            
                new <span class="type-signature"></span>RelativePosition<span class="signature">(type, tname, item)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_RelativePosition.js.html">utils/RelativePosition.js</a></code>,
                <code><a href="utils_RelativePosition.js.html#line49">line 49</a></code>
            </div>
...
<span class="param-type">null</span>
        ...
        <tr>
                ...
                <td class="name"><code>tname</code></td>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>// Current cursor position is at position 10
  ...
  console.log('cursor location is ' + absolutePosition.index) // => cursor location is 3</code></pre>
...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="RelativePosition.html">RelativePosition</a>
                <div class="container-source members">
                    <code><a href="RelativePosition.html">RelativePosition</a></code>
                </div>
            </h4>
        </dt>
...
<h4 class="name" id="item">
    <span class="type-signature"></span>item<span class="type-signature"> :<a href="ID.html">ID</a>|null</span>
    
    <div class="container-source members">
        <code><a href="utils_RelativePosition.js.html">utils/RelativePosition.js</a></code>,
        <code><a href="utils_RelativePosition.js.html#line61">line 61</a></code>
    </div>
...
<dt>
<h4 class="name" id="tname">
    <span class="type-signature"></span>tname<span class="type-signature"> :string|null</span>
    
    <div class="container-source members">
        <code><a href="utils_RelativePosition.js.html">utils/RelativePosition.js</a></code>,
        <code><a href="utils_RelativePosition.js.html#line57">line 57</a></code>
    </div>
...
<h4 class="name" id="type">
    <span class="type-signature"></span>type<span class="type-signature"> :<a href="ID.html">ID</a>|null</span>
    
    <div class="container-source members">
        <code><a href="utils_RelativePosition.js.html">utils/RelativePosition.js</a></code>,
        <code><a href="utils_RelativePosition.js.html#line53">line 53</a></code>
    </div>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'RelativePosition_sub'.replace(/"/g, '_');
